        ...
        inputSchema: { 
            ...
            properties: {
                ...
                categories: { 
                    ...
                    items: { 
                        type: "string",
                        enum: ["Content Creation", "Image Generation", "Video Generation", "Audio Generation", "Code Generation", "Data Analysis", "Research & Knowledge", "Education & Tutoring", "Customer Support", "Sales & Marketing", "Finance & Accounting", "Healthcare & Wellness", "Travel & Hospitality", "Gaming", "Productivity & Tools", "Social Media", "E-commerce", "Legal", "Real Estate", "Human Resources", "Personal Assistant", "Security & Compliance", "Developer Tools", "Design & UI/UX", "Language Learning", "Music & Entertainment", "Science & Engineering", "News & Information", "Food & Cooking", "IoT & Smart Home", "Robotics Control", "Accessibility", "Simulation & Modeling", "Ethical AI & Bias Detection", "API Integration & Orchestration"]
                    }, 
