        ...
        inputSchema: { 
            ...
            properties: {
                ...
                categories: { 
                    ...
                    items: { 
                        type: "string",
                        enum: ["Personal Assistant", "Home Automation", "Health Monitoring", "Telemedicine", "Mental Health", "Fitness Coaching", "Nutrition Planning", "Elder Care", "Childcare Support", "Language Tutor", "Language Translation", "Document Summaries", "Legal Advice", "Tax Preparation", "Financial Planning", "Investment Advisory", "Budget Tracking", "Expense Tracking", "Bill Payment", "Customer Support", "Sales Chatbot", "Lead Generation", "Marketing Automation", "Ad Optimization", "Social Media", "Influence Analysis", "Content Creation", "Copywriting", "Blogging Assistant", "Script Writing", "Video Editing", "Photo Editing", "Graphic Design", "UI Design", "UX Research", "Voice Assistant", "IoT Management", "Energy Management", "Smart Grid", "Predictive Maintenance", "Fleet Management", "Route Optimization", "Logistics Planning", "Supply Chain", "Inventory Management", "Warehouse Automation", "Quality Control", "Manufacturing Ops", "Drone Management", "Robotics Control", "Crop Monitoring", "Precision Agriculture", "Environmental Monitoring", "Water Management", "Weather Forecasting", "Disaster Prediction", "Public Safety", "Security Monitoring", "Surveillance", "Access Control", "Fraud Detection", "Cybersecurity", "Privacy Protection", "Identity Verification", "Biometrics", "Emotion Analysis", "Behavioral Analytics", "Recommendation", "Personalization", "Data Analysis", "Predictive Analytics", "Anomaly Detection", "Business Intelligence", "Workflow Automation", "DevOps", "Code Generation", "Automated Testing", "API Management", "Software Debugging", "Model Training", "Hyperparameter Tuning", "AB Testing", "Research Assistant", "Knowledge Base", "Meeting Transcription", "Virtual Events", "Remote Work", "Team Collaboration", "Project Management", "Time Tracking", "Task Automation", "Personal Finance", "Retirement Planning", "Insurance Underwriting", "Loan Underwriting", "Risk Management", "Chat Moderation", "Voice Biometrics", "Facial Recognition", "Smart Retail"]
                    }, 
